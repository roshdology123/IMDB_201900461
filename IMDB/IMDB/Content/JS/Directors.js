...
function details() {
    var x = document.getElementById("director-details");
...
function RemoveDirector1() {
    var element = document.getElementById("director1-container");
    var x = document.getElementById("director-details");
    if (x.style.display === "block") {
...
const Movies = document.getElementById("director-movies");
